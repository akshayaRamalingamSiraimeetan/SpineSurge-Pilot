 ...
 *
 * PORTED VERBATIM from the old repo (src/renderer/features/dicom/maskUtils.ts) as part of Step 8b.
 * Pure typed-array algorithms (3D flood-fill island filter + multi-pass 3D smoothing), zero external
 * dependencies. Parity-locked against the oracle in test/golden — do not change results without a
 * divergence entry (LOGIC_PORT_PLAN §4).
 */
