/**
 * Pedicle-screw size catalog by spinal level/region.
 *
 * PORTED VERBATIM from the old repo (src/renderer/features/measurements/planning/ScrewDefaults.ts)
 * as part of Step 8a. Pure lookup data + helper, zero external dependencies. Parity-locked against
 * the oracle in test/golden — do not change values without a divergence entry (LOGIC_PORT_PLAN §4).
 */
