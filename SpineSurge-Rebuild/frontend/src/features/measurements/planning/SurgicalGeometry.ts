 ...
 *
 * PORTED VERBATIM from the old repo (src/renderer/features/measurements/planning/SurgicalGeometry.ts)
 * as part of Step 8a. Pure vector math, zero external dependencies. Behavior is parity-locked against
 * the oracle in test/golden — do not change results without a divergence entry (LOGIC_PORT_PLAN §4).
 */
