            ...
            <DialogContent className={cn(
                ...
                <div className="space-y-6 py-4">
                    <div className="space-y-4">
                        <h4 className="text-xs font-bold uppercase tracking-wider text-blue-600">Workspace</h4>

                        <div className={cn("flex items-center justify-between p-3 rounded-lg border", isDark ? "border-[#1E3A5F] bg-[#0A1929]/60" : "border-gray-300 bg-gray-200")}>
                            <div className="flex items-center gap-3">
                                <Monitor className="h-4 w-4 text-slate-400" />
                                <div className="space-y-0.5">
                                    <div className="text-sm font-medium">Measurement Auto-save</div>
                                    <div className={cn("text-[10px]", isDark ? "text-[#90CAF9]/70" : "text-slate-600")}>Automatically save changes to the cloud</div>
                                </div>
                            </div>
                        ...
                        <div className={cn("flex items-center justify-between p-3 rounded-lg border", isDark ? "border-[#1E3A5F] bg-[#0A1929]/60" : "border-gray-300 bg-gray-200")}>
                            <div className="flex items-center gap-3">
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    <div className={cn("text-[10px]", isDark ? "text-[#90CAF9]/70" : "text-slate-600")}>Alert when AI analysis is complete</div>
                                </div>
                            </div>
                    ...
                    <div className="space-y-4">
                        <h4 className="text-xs font-bold uppercase tracking-wider text-blue-600">Security & Language</h4>

                        <div className="grid grid-cols-2 gap-3">
                            <Button variant="outline" className={cn("justify-start gap-2 h-10", isDark ? "border-[#1E3A5F] bg-[#0A1929] text-[#E3F2FD] hover:bg-[#29B6F6]/10" : "border-gray-300 bg-white text-slate-900 hover:bg-gray-200")}>
                ...
                <div className="flex justify-end pt-2 gap-3">
                    <Button variant="ghost" onClick={() => onOpenChange(false)} className={cn("text-xs", isDark ? "text-[#90CAF9] hover:text-[#E3F2FD] hover:bg-[#29B6F6]/10" : "text-slate-700 hover:text-slate-900 hover:bg-gray-200")}>Reset to Defaults</Button>
